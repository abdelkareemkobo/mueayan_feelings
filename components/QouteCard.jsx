...
const QouteCard = ({ post, handleEdit, handleDelete, handleTagClick }) => {
  ...
  return (
    <div className='prompt_card'>
      <div className='flex items-start justify-between gap-5'>
        ...
        <div className='copy_btn' onClick={handleCopy}>
          <Image
            ...
            alt={copied === post.qoute ? "tick_icon" : "copy_icon"}
            width={12}
            height={12}
          />
        </div>
      ...
      <p className='my-4 text-sm text-gray-700 font-satoshi'>{post.qoute}</p>
      <p
